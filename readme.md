...
*(Place these files in `/assets/` to show in WordPress.org)*

== Changelog ==

= 2.5 =
* Fixed complex ID selector issues
* Improved deep linking and hash behavior
* Enhanced vertical layout rendering
* Improved theme-variable CSS support

= 2.0 =
* Added dynamic CPT + taxonomy loading
* Introduced built-in search bar
...
= 2.5 =
Improved stability, ID handling, and UI behavior. Update recommended.
